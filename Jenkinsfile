...
def envDef = [ compliance: complianceFlags, buildImage: "331455399823.dkr.ecr.us-east-2.amazonaws.com/sfci/sfci/centos7-sfci-jdk11-maven:a505f62", maxDaysToKeepBuild: 10 , maxNumToKeepBuild: 100]	
